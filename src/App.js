...
function App() {
  ...
  const refs = [
    {ref: starRef1, velocity: 0.13},
    {ref: starRef2, velocity: 0.16},
    {ref: starRef3, velocity: 0.2}
  ];
  const velocity = 0.1;
  ...
  useEffect(() => {
    function scrollEffects() {
      ...
      refs.forEach(ref => {
        ref.ref.current.style.backgroundPosition = `0 ${Math.round(pos * ref.velocity)}px`;
      })
